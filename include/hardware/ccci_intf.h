...
static struct ccci_node ccci_node_list[] = {
	...
	{USR_MUXD_DATA,		{"/dev/ttyC0",					"/dev/ttyC0",					  "/dev/ttyC0",					  "/dev/ccci2_tty0",		   INVALID_NAME,			 "/dev/eemcs_mux",        "/dev/emd_cfifo1"}},
	{USR_MUXR_IOCTL,	{"/dev/ccci_uem_tx",		"/dev/ccci_ioctl0",		  "/dev/ccci_ioctl0",		  "/dev/ccci2_ioctl0",	   INVALID_NAME,		   "/dev/eemcs_muxrp",      "/dev/emd_ctl1"}},
	{USR_RILD_IOCTL,	{INVALID_NAME,					"/dev/ccci_ioctl1",		  "/dev/ccci_ioctl1",		  "/dev/ccci2_ioctl1",	   INVALID_NAME,		   "/dev/eemcs_ril",        "/dev/emd_ctl2"}},
	{USR_TERS_IOCTL,	{INVALID_NAME,					"/dev/ccci_ioctl2",		  "/dev/ccci_ioctl2",		  "/dev/ccci2_ioctl2",	   INVALID_NAME,		   "/dev/eemcs_ioctl",      INVALID_NAME}},
	{USR_AUDIO_TX,		{"/dev/ccci_pcm_tx",		"/dev/ccci_pcm_tx",		  "/dev/ccci_aud",			  "/dev/ccci2_aud",	       INVALID_NAME,			 "/dev/eemcs_aud",        INVALID_NAME}},
	{USR_AUDIO_RX,		{"/dev/ccci_pcm_rx",		"/dev/ccci_pcm_rx",		  "/dev/ccci_aud",			  "/dev/ccci2_aud",	       INVALID_NAME,			 "/dev/eemcs_aud",        INVALID_NAME}},
	{USR_META_DATA,		{"/dev/ttyC1",					"/dev/ttyC1",					  "/dev/ttyC1",					  "/dev/ccci2_tty1",		   INVALID_NAME,			 "/dev/eemcs_md_log",     INVALID_NAME}},
	{USR_META_IOCTL,	{INVALID_NAME,					"/dev/ccci_ioctl4",		  "/dev/ccci_ioctl4",		  "/dev/ccci2_ioctl4",	   INVALID_NAME,		   INVALID_NAME,            "/dev/emd_ctl3"}},
	{USR_MDLOG_TX,		{"/dev/ccci_md_log_tx",	"/dev/ccci_md_log_tx",	"/dev/ttyC1",					  "/dev/ccci2_tty1",	     INVALID_NAME,			 "/dev/eemcs_md_log",     INVALID_NAME}},
	{USR_MDLOG_RX,		{"/dev/ccci_md_log_rx",	"/dev/ccci_md_log_rx",	"/dev/ttyC1",					  "/dev/ccci2_tty1",	     INVALID_NAME,			 "/dev/eemcs_md_log",     INVALID_NAME}},
	{USR_MDLOG_IOCTL,	{"/dev/ccci_uem_rx",		"/dev/ccci_ioctl0",		  "/dev/ttyC1",					  "/dev/ccci2_tty1",	     INVALID_NAME,			 "/dev/eemcs_md_log",     "/dev/emd_ctl4"}},
	{USR_MDLOG_CTRL,	{INVALID_NAME,			    INVALID_NAME,					  "/dev/ccci_md_log_ctrl","/dev/ccci2_md_log_ctrl",INVALID_NAME,       "/dev/eemcs_md_log_ctrl","/dev/emd_ctl4"}},
	{USR_AGPS_UART,		{"/dev/ttyC2",			    "/dev/ttyC2",					  "/dev/ttyC2",					  "/dev/ccci2_tty2",		   INVALID_NAME,			 "/dev/eemcs_ipc_uart",   INVALID_NAME}},
	{USR_AGPS_IPC,		{"/dev/ccci_ipc_1220_0","/dev/ccci_ipc_1220_0",	"/dev/ccci_ipc_1220_0",	"/dev/ccci2_ipc_0",		 	 INVALID_NAME,	     "/dev/eemcs_ipc_0",      INVALID_NAME}},
	{USR_GPS_IPC,			{INVALID_NAME,			    "/dev/ccci_ipc_2",		  "/dev/ccci_ipc_2",		  "/dev/ccci2_ipc_2",		   INVALID_NAME,		   "/dev/eemcs_ipc_2",      INVALID_NAME}},
	{USR_NET_0,			  {"ccmni0",				      "ccmni0",				        "ccmni0",				        "cc2mni0",				       "cc3mni0",				   "ccemni0",               INVALID_NAME}},
	{USR_NET_1,			  {"ccmni1",				      "ccmni1",				        "ccmni1",				        "cc2mni1",				       "cc3mni1",				   "ccemni1",               INVALID_NAME}},
	{USR_NET_2,			  {"ccmni2",				      "ccmni2",				        "ccmni2",				        "cc2mni2",				       "cc3mni2",			  	 "ccemni2",               INVALID_NAME}},
	{USR_NET_3,			  {"ccmni3",				      "ccmni3",				        "ccmni3",				        "cc2mni3",				       "cc3mni3",				   "ccemni3",				        INVALID_NAME}},
	{USR_NET_4,			  {"ccmni4",				      "ccmni4",				        "ccmni4",				        "cc2mni4",				       "cc3mni4",			  	 "ccemni4",				        INVALID_NAME}},
	{USR_NET_5,			  {"ccmni5",				      "ccmni5",				        "ccmni5",				        "cc2mni5",				       "cc3mni5",			  	 "ccemni5",				        INVALID_NAME}},
	{USR_NET_6,			  {"ccmni6",				      "ccmni6",				        "ccmni6",				        "cc2mni6",				       "cc3mni6",				   "ccemni6",				        INVALID_NAME}},
	{USR_NET_7,			  {"ccmni7",				      "ccmni7",				        "ccmni7",				        "cc2mni7",				       "cc3mni7",				   "ccemni7",				        INVALID_NAME}},
	{USR_IMS_AUDIO,		{INVALID_NAME,			    INVALID_NAME,			      "/dev/ccci_imsa",		    "/dev/ccci2_imsa",		   INVALID_NAME,		   "/dev/eemcs_imsa",       INVALID_NAME}},
	{USR_IMS_VEDIO,		{INVALID_NAME,			    INVALID_NAME,			      "/dev/ccci_imsv",		    "/dev/ccci2_imsa",		   INVALID_NAME,		   "/dev/eemcs_imsv",       INVALID_NAME}},
	{USR_IMS_CTRL,		{INVALID_NAME,			    INVALID_NAME,			      "/dev/ccci_imsc",		    "/dev/ccci2_imsa",		   INVALID_NAME,		   "/dev/eemcs_imsc",       INVALID_NAME}},
	{USR_IMS_DCTRL,		{INVALID_NAME,			    INVALID_NAME,			      "/dev/ccci_imsdc",		  "/dev/ccci2_imsa",		   INVALID_NAME,		   "/dev/eemcs_imsdc",      INVALID_NAME}},
	{USR_ICUSB_DATA,	{INVALID_NAME,			    "/dev/ttyC3",			      "/dev/ttyC3",					  "/dev/ccci2_tty3",		   INVALID_NAME,			 INVALID_NAME,            INVALID_NAME}},
	{USR_ICUSB_IOCTL,	{INVALID_NAME,			    "/dev/ccci_ioctl3",		  "/dev/ccci_ioctl3",		  "/dev/ccci2_ioctl3",	   INVALID_NAME,		   INVALID_NAME,            INVALID_NAME}},
	{USR_CCCI_FS,			{"/dev/ccci_fs",		    "/dev/ccci_fs",				  "/dev/ccci_fs",				  "/dev/ccci2_fs",			   INVALID_NAME,			 "/dev/eemcs_fs",         INVALID_NAME}},
	{USR_CCCI_CTRL,		{"/dev/ccci_uem_rx",		"/dev/ccci_monitor",	  "/dev/ccci_monitor",	  "/dev/ccci2_monitor",	   INVALID_NAME,	     "/dev/eemcs_ctrl",       "/dev/emd_ctl0"}},
	{USR_MISC_TA_IPC, {INVALID_NAME,        	INVALID_NAME,           "/dev/ccci_ipc_4",      "/dev/ccci2_ipc_4",      INVALID_NAME,       INVALID_NAME,            INVALID_NAME}},
	{USR_CCCI_RPC,		{"/dev/ccci_rpc",		    "/dev/ccci_rpc",	      "/dev/ccci_rpc",		    "/dev/ccci2_rpc",	       INVALID_NAME,		   "/dev/eemcs_rpc",        INVALID_NAME}},
};
/**
...
#define CCCI_IOC_SET_NOTAUTOK				_IO(CCCI_IOC_MAGIC,  123)				/*mdinit*/
